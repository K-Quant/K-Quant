...
if __name__ == '__main__':
    ...
    """
#     sys.argv += '--model_name HIST --outdir ./output/HIST/2024Q1 --lr 0.0001 --smooth_step 1 --n_epochs 50 --repeat 1 --early_stop 5 --train_start_date 2008-01-01 --train_end_date 2023-09-30 --valid_start_date 2023-10-01 --valid_end_date 2023-12-31 --test_start_date 2024-01-01 --test_end_date 2024-03-31 --n_split_test 1'.split()
    args = parse_args()
