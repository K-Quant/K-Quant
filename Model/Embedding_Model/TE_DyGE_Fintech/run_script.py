...
parser.add_argument('--max_time', type=int, nargs='?', default=63, help='max_time step')
...
parser.add_argument('--dataset', type=str, nargs='?', default='FinKG',
                    help='dataset name')

parser.add_argument('--GPU_ID', type=int, nargs='?', default=4,
                    help='GPU_ID (0/1 etc.)')
...
parser.add_argument('--walk_len', type=int, nargs='?', default=80,
...
parser.add_argument('--learning_rate', type=float, nargs='?', default=0.0005,
...
# Here, t=2 => learn on graph (idx = 0) and predict the links of graph (idx = 1).  #### run tran.py
commands = []
